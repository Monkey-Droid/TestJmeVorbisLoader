package com.scrappers.testjmevorbisloader;
...
import com.scrappers.testjmevorbisloader.test.TestOgg;
 ...
 * <br/>
 * An Android Example that demonstrates : How to use a simple game#{@link }
...
public final class MainActivity extends AppCompatActivity implements OnRendererCompleted, OnExceptionThrown {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final JmeSurfaceView jmeSurfaceView = findViewById(R.id.surfaceview);
        jmeSurfaceView.setDestructionPolicy(JmeSurfaceView.DestructionPolicy.KEEP_WHEN_FINISH);
        /*set the jme game*/
        jmeSurfaceView.setLegacyApplication(new TestOgg());
